...
const vi = {
  ...
  'onboarding.step1Next': 'Tiếp tục: Mở khóa Mac →',
  'onboarding.step2Next': 'Tiếp tục: Phím tắt & AI →',
  'onboarding.step3Next': 'Tiếp tục: Hoàn tất →',
  'onboarding.finish': 'Bắt đầu sử dụng TouchPass 🚀',
  'onboarding.step1Title': 'Kết nối & Chẩn đoán',
  'onboarding.step2Title': 'Mở khóa Mac',
  'onboarding.step3Title': 'Phím tắt & AI',
  'onboarding.step4Title': 'Sẵn sàng',
  ...
  'onboarding.diagnosticsTitle': 'Chẩn đoán phần cứng',
...
const en: Record<TranslationKey, string> = {
  ...
  'onboarding.step1Next': 'Next: Mac Unlock →',
  'onboarding.step2Next': 'Next: Shortcuts & AI →',
  'onboarding.step3Next': 'Next: Ready →',
  'onboarding.finish': 'Start using TouchPass 🚀',
  'onboarding.step1Title': 'Connect & Diagnose',
  'onboarding.step2Title': 'Mac Unlock',
  'onboarding.step3Title': 'Shortcuts & AI',
  'onboarding.step4Title': 'Ready',
...
const zhCN: Record<TranslationKey, string> = {
  ...
  'button.saveAndEnroll': '保存并录入指纹', 'button.saveChanges': '保存更改', 'button.more': '更多', 'button.test': '测试操作', 'button.rescan': '重新录入指纹', 'button.disable': '禁用操作', 'button.enable': '启用操作', 'button.delete': '删除指纹', 'button.cancel': '取消', 'button.close': '关闭', 'button.confirmDelete': '删除指纹',
  ...
  'onboarding.back': '返回',
  'onboarding.next': '下一步',
  'onboarding.step1Next': '下一步: Mac 解锁 →',
  'onboarding.step2Next': '下一步: 快捷键与 AI →',
  'onboarding.step3Next': '下一步: 完成就绪 →',
  'onboarding.finish': '开始使用 TouchPass 🚀',
  'onboarding.step1Title': '连接与诊断',
  'onboarding.step2Title': 'Mac 解锁',
  'onboarding.step3Title': '快捷键与 AI',
  'onboarding.step4Title': '完成就绪',
